...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/alcopastorefront/electronics/en",
						"https://electronics.local:9002/alcopastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/alcopastorefront/electronics/en",
						"https://electronics.local:9002/alcopastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/alcopastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/alcopastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/alcopastorefront/electronics/en",
						"https://electronics.local:9002/alcopastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/alcopastorefront",
						"https://electronics.local:9002/alcopastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/alcopastorefront",
						"https://electronics.local:9002/alcopastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/alcopastorefront/electronics/en",
						"https://electronics.local:9002/alcopastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
