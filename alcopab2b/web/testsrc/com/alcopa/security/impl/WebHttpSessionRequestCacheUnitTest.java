...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/alcopab2b/electronics/en",
						"https://electronics.local:9002/alcopab2b/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/alcopab2b/electronics/en",
						"https://electronics.local:9002/alcopab2b/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/alcopab2b/electronics/ja/Y/Z",
						"https://electronics.local:9002/alcopab2b/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/alcopab2b/electronics/en",
						"https://electronics.local:9002/alcopab2b/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/alcopab2b",
						"https://electronics.local:9002/alcopab2b"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/alcopab2b",
						"https://electronics.local:9002/alcopab2b/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/alcopab2b/electronics/en",
						"https://electronics.local:9002/alcopab2b/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
