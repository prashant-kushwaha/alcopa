 ...
 */
package com.alcopa.cockpits.setup;
...
import com.alcopa.cockpits.constants.AlcopaCockpitsConstants;
 ...
 */
@SystemSetup(extension = AlcopaCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AlcopaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AlcopaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AlcopaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/alcopacockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
