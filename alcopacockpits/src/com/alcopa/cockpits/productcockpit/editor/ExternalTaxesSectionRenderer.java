 ...
 */
package com.alcopa.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("alcopacockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("alcopacockpits.product.externalTaxes"));
