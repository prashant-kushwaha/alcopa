 ...
 */
package com.alcopa.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AlcopaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AlcopaFulfilmentProcessConstants.PARENT_PROCESS);
